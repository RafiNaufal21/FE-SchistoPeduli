          ...
          <div className="row g-5">
            <div className="col-lg-3 col-md-6">
              <h1 className="text-white">
                Schisto<span className="fw-bold text-primary mb-4">Peduli</span>
              </h1>
              <p>
                Schisto Peduli siap membantu, Saling Menolong Siapa Saja dan
                Kapan Saja
              </p>
            ...
            <div className="col-lg-3 col-md-6">
              ...
              <p>
                <i className="fa fa-map-marker-alt me-3"></i>Lore Utara,
              ...
              <p>
                <i className="fa fa-envelope me-3"></i>Schistopeduli@gmail.com
              </p>
            </div>
            <div className="col-lg-3 col-md-6">
              ...
              <a className="btn btn-link" href="/Eduschisto">
                Eduschisto
              </a>
